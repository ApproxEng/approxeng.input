...
As of version 2.5.0, you can also query for button releases in the same way. Because the return type for :meth:`~approxeng.input.Controller.check_presses`
has not changed, you can only access the button releases through the parent controller object's `releases` property, i.e.
